    ...
    products: [
      {
        ...
        productImg: require("../images/product/vegebom_bebe.png"),
        ficheImg: require("../images/fiche/vegebom_bebe.jpg"),
      },
      {
        id: 2,
        name: "Dermasept® Cica",
        productImg: require("../images/product/dermasept_cica.png"),
        ficheImg: require("../images/fiche/dermasept_cica.jpg"),
      },
      {
        id: 3,
        name: "Dermasept®",
        productImg: require("../images/product/dermasept.png"),
