...
export const CATEGORIES: Category[] = [
  ...
  //       id: 1,
  //       name: "Nurax®",
  //       productImg: require("../images/product/nurax.jpg"),
  //       ficheImg: require("../images/fiche/nurax.jpg"),
  //     },
  //     {
  //       id: 2,
  //       name: "Apenat®",
  //       productImg: require("../images/product/apenat.jpg"),
  //       ficheImg: require("../images/fiche/apenat.jpg"),
  //     },
  //     {
  //       id: 3,
  //       name: "Maxitone®",
  //       productImg: require("../images/product/maxitone.jpg"),
  //       ficheImg: require("../images/fiche/maxitone.jpg"),
  //     },
  //     {
  //       id: 4,
  //       name: "Maxitone® Comprimés effervescents",
  //       productImg: require("../images/product/maxitone_eff.jpg"),
  //       ficheImg: require("../images/fiche/maxitone_eff.jpg"),
  //     },
  //     {
  //       id: 5,
  //       name: "Nurax® Tonus",
  //       productImg: require("../images/product/nurax_tonus.jpg"),
  //       ficheImg: require("../images/fiche/nurax_tonus.jpg"),
  //     },
  //     {
  //       id: 6,
  //       name: "Dynatens®",
  //       productImg: require("../images/product/dynatens.jpg"),
  //       ficheImg: require("../images/fiche/dynatens.jpg"),
  //     },
  //     {
  //       id: 7,
  //       name: "Fitofer®",
  //       productImg: require("../images/product/fitofer.jpg"),
  //       ficheImg: require("../images/fiche/fitofer.jpg"),
  //     },
  //     {
  //       id: 8,
  //       name: "Memotone®",
  //       productImg: require("../images/product/memotone.jpg"),
  ...
  //       id: 1,
  //       name: "Apixol® Sirop",
  //       productImg: require("../images/product/apixol_sirop.jpg"),
  //       ficheImg: require("../images/fiche/apixol_sirop.jpg"),
  //     },
  //     {
  //       id: 2,
  //       name: "Apixol® Comprimés à sucer",
  //       productImg: require("../images/product/apixol_comprimes.jpg"),
  //       ficheImg: require("../images/fiche/apixol_comprimes.jpg"),
  //     },
  //     {
  //       id: 3,
  //       name: "Apixol® Spray gorge",
  //       productImg: require("../images/product/apixol_spray_gorge.jpg"),
  //       ficheImg: require("../images/fiche/apixol_spray_gorge.jpg"),
  //     },
  //     {
  //       id: 4,
  //       name: "Apixol® Spray nasal",
  //       productImg: require("../images/product/apixol_spray_nasal.jpg"),
  //       ficheImg: require("../images/fiche/apixol_spray_nasal.jpg"),
  //     },
  //     {
  //       id: 5,
  //       name: "Fitopolis® Sirop",
  //       productImg: require("../images/product/fitopolis_sirop.jpg"),
  //       ficheImg: require("../images/fiche/fitopolis_sirop.jpg"),
  //     },
  //     {
  //       id: 6,
  //       name: "Fitopolis® Spray gorge",
  //       productImg: require("../images/product/fitopolis_spray.jpg"),
  //       ficheImg: require("../images/fiche/fitopolis_spray.jpg"),
  //     },
  //     {
  //       id: 7,
  //       name: "Fitopolis® Comprimés à sucer",
  //       productImg: require("../images/product/fitopolis_comprimes.jpg"),
  //       ficheImg: require("../images/fiche/fitopolis_comprimes.jpg"),
  //     },
  //     {
  //       id: 8,
  //       name: "Tossedyl®",
  //       productImg: require("../images/product/tossedyl.jpg"),
  //       ficheImg: require("../images/fiche/tossedyl.jpg"),
  //     },
  //     {
  //       id: 9,
  //       name: "Fitorax® Sirop",
  //       productImg: require("../images/product/fitorax_sirop.jpg"),
  //       ficheImg: require("../images/fiche/fitorax_sirop.jpg"),
  //     },
  //     {
  //       id: 10,
  //       name: "Fitorax® Spray gorge",
  //       productImg: require("../images/product/fitorax_spray.jpg"),
  //       ficheImg: require("../images/fiche/fitorax_spray.jpg"),
  //     },
  //     {
  //       id: 11,
  //       name: "Fitorax® Comprimés à sucer",
  //       productImg: require("../images/product/fitorax_comprimes.jpg"),
  //       ficheImg: require("../images/fiche/fitorax_comprimes.jpg"),
  //     },
  //     {
  //       id: 12,
  //       name: "Curaler® Sirop",
  //       productImg: require("../images/product/curaler_sirop.jpg"),
  //       ficheImg: require("../images/fiche/curaler_sirop.jpg"),
  //     },
  //     {
  //       id: 13,
  //       name: "Curaler® Gellules",
  //       productImg: require("../images/product/curaler_gellules.jpg"),
  //       ficheImg: require("../images/fiche/curaler_gellules.jpg"),
  //     },
  //     {
  //       id: 14,
  //       name: "Curaler® Spray nasal",
  //       productImg: require("../images/product/curaler_spray.jpg"),
  //       ficheImg: require("../images/fiche/curaler_spray.jpg"),
  //     },
  //     {
  //       id: 15,
  //       name: "Rhinolaya®",
  //       productImg: require("../images/product/rhinolaya.jpg"),
  //       ficheImg: require("../images/fiche/rhinolaya.jpg"),
  //     },
  //     {
  //       id: 16,
  //       name: "Otolaya®",
  //       productImg: require("../images/product/otolaya.jpg"),
  //       ficheImg: require("../images/fiche/otolaya.jpg"),
  //     },
  //     {
  //       id: 17,
  //       name: "Nobios® Comprimés",
  //       productImg: require("../images/product/nobios_comprimes.jpg"),
  //       ficheImg: require("../images/fiche/nobios_comprimes.jpg"),
  //     },
  //     {
  //       id: 18,
  //       name: "Nobios® Sirop",
  //       productImg: require("../images/product/nobios_sirop.jpg"),
  //       ficheImg: require("../images/fiche/nobios_sirop.jpg"),
  //     },
  //     {
  //       id: 19,
  //       name: "Biotinax®",
  //       productImg: require("../images/product/biotinax.jpg"),
  //       ficheImg: require("../images/fiche/biotinax.jpg"),
  //     },
  //     {
  //       id: 20,
  //       name: "Neovizinc®",
  //       productImg: require("../images/product/neovizinc.jpg"),
  //       ficheImg: require("../images/fiche/neovizinc.jpg"),
  //     },
  //     {
  //       id: 21,
  //       name: "Maxitone® Vitamine C",
  //       productImg: require("../images/product/maxitone_vitc.jpg"),
  ...
  //       id: 1,
  //       name: "D3Norm®",
  //       productImg: require("../images/product/d3norm.jpg"),
  //       ficheImg: require("../images/fiche/d3norm.jpg"),
  //     },
  //     {
  //       id: 2,
  //       name: "Curogyl®",
  //       productImg: require("../images/product/curogyl.jpg"),
  //       ficheImg: require("../images/fiche/curogyl.jpg"),
  //     },
  //     {
  //       id: 3,
  //       name: "Curarti® Forte",
  //       productImg: require("../images/product/curarti_forte.jpg"),
  //       ficheImg: require("../images/fiche/curarti_forte.jpg"),
  //     },
  //     {
  //       id: 4,
  //       name: "Curarti® Gel",
  //       productImg: require("../images/product/curarti_gel.jpg"),
  //       ficheImg: require("../images/fiche/curarti_gel.jpg"),
  //     },
  //     {
  //       id: 5,
  //       name: "Curaflex®",
  //       productImg: require("../images/product/curaflex.jpg"),
  //       ficheImg: require("../images/fiche/curaflex.jpg"),
  //     },
  //     {
  //       id: 6,
  //       name: "Neuraxone®",
  //       productImg: require("../images/product/neuraxone.jpg"),
  //       ficheImg: require("../images/fiche/neuraxone.jpg"),
  //     },
  //     {
  //       id: 7,
  //       name: "Cartigen®",
  //       productImg: require("../images/product/cartigen.jpg"),
  //       ficheImg: require("../images/fiche/cartigen.jpg"),
  //     },
  //     {
  //       id: 8,
  //       name: "Cartigen® Protect",
  //       productImg: require("../images/product/cartigen_protect.jpg"),
  //       ficheImg: require("../images/fiche/cartigen_protect.jpg"),
  //     },
  //     {
  //       id: 9,
  //       name: "Ainat® Comprimés",
  //       productImg: require("../images/product/ainat_comprimes.jpg"),
  //       ficheImg: require("../images/fiche/ainat_comprimes.jpg"),
  //     },
  //     {
  //       id: 10,
  //       name: "Ainat® Roll-on",
  //       productImg: require("../images/product/ainat_rollon.jpg"),
  //       ficheImg: require("../images/fiche/ainat_rollon.jpg"),
  //     },
  //     {
  //       id: 11,
  //       name: "Duorelax®",
  //       productImg: require("../images/product/duorelax.jpg"),
  //       ficheImg: require("../images/fiche/duorelax.jpg"),
  //     },
  //     {
  //       id: 12,
  //       name: "Vegebom®",
  //       productImg: require("../images/product/vegebom.jpg"),
  //       ficheImg: require("../images/fiche/vegebom.jpg"),
  //     },
  //     {
  //       id: 13,
  //       name: "Neovical®",
  //       productImg: require("../images/product/neovical.jpg"),
  //       ficheImg: require("../images/fiche/neovical.jpg"),
  //     },
  //     {
  //       id: 14,
  //       name: "Fitoflex®",
  //       productImg: require("../images/product/fitoflex.jpg"),
  ...
  //       productImg: require("../images/product/candidax_ovules.jpg"),
  //       ficheImg: require("../images/fiche/candidax_ovules.jpg"),
  //     },
  //     {
  //       id: 2,
  //       name: "Candidax®",
  //       productImg: require("../images/product/candidax.jpg"),
  //       ficheImg: require("../images/fiche/candidax.jpg"),
  //     },
  //     {
  //       id: 3,
  //       name: "Dermasept® Gel lavant",
  //       productImg: require("../images/product/dermasept_gel.jpg"),
  //       ficheImg: require("../images/fiche/dermasept_gel.jpg"),
  //     },
  //     {
  //       id: 4,
  //       name: "Dermasept® PH8",
  //       productImg: require("../images/product/dermasept_ph8.jpg"),
  //       ficheImg: require("../images/fiche/dermasept_ph8.jpg"),
  //     },
  //     {
  //       id: 5,
  //       name: "Fitolat®",
  //       productImg: require("../images/product/fitolat.jpg"),
  //       ficheImg: require("../images/fiche/fitolat.jpg"),
  //     },
  //     {
  //       id: 6,
  //       name: "Neonat®",
  //       productImg: require("../images/product/neonat.jpg"),
  //       ficheImg: require("../images/fiche/neonat.jpg"),
  //     },
  //     {
  //       id: 7,
  //       name: "Genestin® Forte",
  //       productImg: require("../images/product/genestin_forte.jpg"),
  //       ficheImg: require("../images/fiche/genestin_forte.jpg"),
  //     },
  //     {
  //       id: 8,
  //       name: "Genestin® SPM",
  //       productImg: require("../images/product/genestin_spm.jpg"),
  //       ficheImg: require("../images/fiche/genestin_spm.jpg"),
  //     },
  //     {
  //       id: 9,
  //       name: "Cystican®",
  //       productImg: require("../images/product/cystican.jpg"),
